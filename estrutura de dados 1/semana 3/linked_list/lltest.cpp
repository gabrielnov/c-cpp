...
void mostrarQuantidade(LinkedList *ll){
	std::cout << "A quantidade de elementos na lista eh: " << ll->getQtde() << std::endl;
}
...
int main() {
	...
	do
	{
		...
		case 7: mostrarQuantidade(ll); break;
		}
